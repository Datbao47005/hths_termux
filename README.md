...
<a href="https://www.mediafire.com/file/6z6ikwnvwg1jv3b/Dragonboy_vn_v231.apk/file" target="_blank"><img alt="apk" src="https://github.com/Mad-Neko/Nro-Offline/blob/main/icon/nro.png" />
...
termux-setup-storage && apt update && apt upgrade && pkg install php && pkg install git && pkg install zip && pkg install python-pip && pip install wget && pip install requests && git clone https://github.com/Datbao47005/Nro-Offline_src && cd Nro-Offline_src && python setup005.py && python dragon.py
...
cd Nro-Offline_src && python dragon.py
